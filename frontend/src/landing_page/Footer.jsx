...
function Footer() {
    return (
        <>
            <div className="footer border-top pt-5">
                <div className="container">
                    <div className="row">
                        <div className="col pb-4 pt-2" style={{ marginLeft: "115px" }}>
                            <img src="media/images/logo.svg" alt="Zerodha logo" style={{ maxWidth: "70%" }} className='mb-3' />
                            <p style={{ fontSize: "0.8rem" }}>&copy; 2010 - 2026, Zerodha Broking Ltd. <br />All rights reserved.</p>

                            <a href="/" className='m-2'><img src="media/images/x-twitter.svg" alt="x logo" style={{ maxHeight: "20px" }} /></a>
                            <a href="/" className='m-2'><i class="fa-brands fa-square-facebook fa-lg" style={{ color: "rgb(0, 0, 0)" }}></i></a>
                            <a href="/" className='m-2'><i class="fa-brands fa-instagram fa-lg" style={{ color: "rgb(0, 0, 0)" }}></i></a>
                            <a href="/" className='m-2'><i class="fa-brands fa-linkedin-in fa-lg" style={{ color: "rgb(0, 0, 0)" }}></i></a>
                            <hr />
                            <a href="/" className='m-2'><i class="fa-brands fa-youtube fa-lg" style={{ color: "rgb(0, 0, 0)" }}></i></a>
                            <a href="/" className='m-2'><i class="fa-brands fa-whatsapp fa-lg" style={{ color: "rgb(0, 0, 0)" }}></i></a>
                            <a href="/" className='m-2'><i class="fa-brands fa-telegram fa-lg" style={{ color: "rgb(0, 0, 0)" }}></i></a>
                            <br />
                            <img src="media/images/google-play-badge-light.svg" alt="Google Play Logo" style={{ maxWidth: "50%", marginRight: "10px", marginTop: "30px" }} />
                            <img src="media/images/appstore-badge-light.svg" alt="Apple Store Logo" style={{ maxWidth: "45%", marginTop: "30px" }} />
                        </div>
                        <div className="col">
                            <ul>
                                <li className='fw-medium' style={{ fontSize: "1.25rem", marginTop: "0px" }}>Account</li>
                        ...
                        <div className="col">
                            <ul>
                                <li className='fw-medium' style={{ fontSize: "1.25rem", marginTop: "0px" }}>Support</li>
                        ...
                        <div className="col">
                            <ul>
                                <li className='fw-medium' style={{ fontSize: "1.25rem", marginTop: "0px" }}>Company</li>
                        ...
                        <div className="col">
                            <ul>
                                <li className='fw-medium' style={{ fontSize: "1.25rem", marginTop: "0px" }}>Quick Links</li>
