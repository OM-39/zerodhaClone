    ...
    return (
        <>
            <div className="container mt-5 pt-5">
                <div className="row">
                    <h2 style={{ fontSize: "1.5rem", lineHeight: "1.5", fontWeight:"500", margin:"70px", marginBottom:"100px"}} className=' text-center'>
                    ...
                    <div className="col about-p mt-5 pt-5" style={{marginLeft:"160px"}}>
                    ...
                    <div className="col about-p  mt-5 pt-5" style={{marginLeft:"10px"}}>
